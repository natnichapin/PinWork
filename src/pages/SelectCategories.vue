...
const AddCategory =async (event)=>{
  ...
  //edit
const editObj  = ref({vocab:"",meaning:""})
const modifyVocabInCategory =async(EditObj,id)=>{
console.log(EditObj.vocabs);
EditObj.vocabs.forEach(x=> console.log(x.word + " " +x.meaning))
console.log(id);
// try {
//     const res = await fetch(
//             `http://localhost:5000/Categoties/${id}`,
//             {
//                 method: 'PUT',
//                 headers: {
//                     'content-type': 'application/json'                },
